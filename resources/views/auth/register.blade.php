...
@section('datas')
    ...
    <div class="container" style="margin-top: 3%; margin-bottom: 3%; height:100%;">
        <div class="login-container-wrapper clearfix" style="max-width: 600px;background-color:white;">
            ...
            <form class="form-horizontal login-form" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success btn-lg btn-block" style="background-color:#395886;color:white">{{ __('Registrasi') }}</button>
                </div>

                <div class="text-center">
                    <label style="color:#395886">Sudah punya akun? <a href="/login" style="color:#395886;" >Login</a></label>
                </div>
            </form>
        </div>
    </div>
