...
@section('content')
    <div class="row d-flex">
        ...
        <div class="card col-md-6 offset-lg-1">
            <div class="card-header text-white" style="background-color:#395886; color:white;">
                <h3 class="mt-2">
                    Ubah Password
                </h3>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="/guru/ubah-pass/{{ auth()->user()->id }}" method="post" id="change_pass_form">
                    ...
                    <div class="card-footer" style="padding: 10px 15px;">
                        ...
                        <button type="submit" class="btn btn-sm" style="background-color: #395886; color:white" id="btn-pass">Perbarui</button>
                    </div>
                </form>
            </div>
        </div>
