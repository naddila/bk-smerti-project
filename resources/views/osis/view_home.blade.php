...
<div class="col-lg-12 mb-4">
    <div class="card shadow-sm bg-white">
        <div class="card-body text-center">
            <h1 class="fw-bold">Selamat Datang, Pembina Osis</h1>
            <p class="text-muted">Mari bersama-sama membangun generasi yang lebih baik <br>dengan mencatat pelanggaran siswa untuk memonitoring perilaku siswa!</p>
        </div>
    </div>
</div>
