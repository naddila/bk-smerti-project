...
@section('datas')
    ...
    {{-- form registrasi siswa | pengisian data --}}
    <div class="container mb-5" style="margin-top: 2%; margin-bottom: 2%; height:100%;">
        <div class="login-container-wrapper clearfix" style="background-color:white">
            <div class="welcome" style="color:#395886;">Data Siswa</div>
            <form class="form-horizontal login-form" method="POST" action="{{ route('siswa') }}">
                ...
                <div class="all-data">
                    <div class="siswa col-lg-7 col-sm-12">
                        ...
                        <input id="nisn" type="hidden"
                            class="form-control input-lg @error('nisn') is-invalid @enderror" name="nisn"
                            value="{{ Auth::user()->nisn }}" required autocomplete="nisn" readonly>

                        @error('nisn')
                            <span class="invalid-feedback ps-1" role="alert">
                                <strong style="color: red; text-shadow: 0 0 5px #fff;">{{ $message }}</strong>
                            </span>
                        @enderror
                        ...
                        <div class="form-group relative1">
                            ...
                            @error('nama')
                                <span class="invalid-feedback ps-1" role="alert">
                                    <strong style="color: darkred; text-shadow: 0 0 5px #fff;">{{ $message }}</strong>
                                </span>
                            @enderror
                        </div>
                ...
                <div class="form-group in-btn mt-3">
                    <button type="submit" class="btn btn-success btn-lg btn-block"
                        style="color:#white; background-color:#395886;">{{ __('Kirim Data') }}</button>
                </div>
            </form>

            <div class="text-center">
                <label style="color:#395886">Ingin keluar?
                    <a href="{{ route('logout') }}"
